...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dropdown_menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dropdown-menu */ "./src/ts/dropdown-menu.ts");

window.onload = function () {
    var hamburger = document.querySelector(".hamburger__icon");
    hamburger.addEventListener("click", _dropdown_menu__WEBPACK_IMPORTED_MODULE_0__["menu"].toggle);
};


/***/ }),

/***/ "./src/ts/dropdown-menu.ts":
/*!*********************************!*\
  !*** ./src/ts/dropdown-menu.ts ***!
  \*********************************/
...
var NavMenu = function () {
    // Enable the use of ESC key to exit menu
    var _handleESC = function (event) {
        if (event.key == "Escape") {
            reverse();
        }
    };
    ...
    var timeline = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline({
        ...
        onStart: function () {
            ...
            addEventListener("keydown", _handleESC, true);
            _dropdownMenuVisible = true;
        },
        onReverseComplete: function () {
            removeEventListener("keydown", _handleESC, true);
            _dropdownMenuVisible = false;
            hamburger.classList.remove("active");
            body.classList.remove("overlay-open");
        },
    });
    var _dropdownMenu = document.querySelector(".dropdown-menu");
    var _dropdownMenuHeight = _dropdownMenu.scrollHeight;
    var _menuLinks = _dropdownMenu.querySelectorAll("a");
    // Menu links
    timeline.set(_menuLinks, {
        autoAlpha: 0,
    ...
    timeline.to(_dropdownMenu, {
        duration: 1,
        height: _dropdownMenuHeight,
        ease: gsap__WEBPACK_IMPORTED_MODULE_0__["Power3"].easeOut,
        force3D: true,
    });
    timeline.to(_menuLinks, {
        duration: 1,
        yPercent: 0,
        xPercent: 0,
        autoAlpha: 1,
    ...
    var isVisible = function () {
        return _dropdownMenuVisible;
    };
    var toggle = function () {
        console.log("isVisible: ", _dropdownMenuVisible);
        console.log("height ", _dropdownMenuHeight);
        isVisible() == true ? reverse() : play();
    };
    var play = function () {
